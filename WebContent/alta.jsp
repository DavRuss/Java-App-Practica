...
<body>
	<h2 align="center">
		<font face="nunito,arial,verdana" color="black" size="32">Alta
			de Usuarios</font>
	</h2>
	<form action="serv" method="post">
		<input type="hidden" name="opcion" value="guardar">
		<table cellspacing="0" cellpadding="2" border="2" width="300"
			align="center">
			<tr>
			...
			<tr>
				<th colspan="2"><input type="submit" name="btnGrabar"
					value="Grabar Usuario" onclick="confirmacion()"></th>
			</tr>
		</table>
		<table align="center">
			<tr>
